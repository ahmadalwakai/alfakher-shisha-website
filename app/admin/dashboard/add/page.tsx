...
import { PRODUCT_CATEGORIES, ProductCategory } from "@/lib/db";
...
export default function AddProductPage() {
  ...
  // Generate placeholder preview URL
      ...
      <header className="bg-white/5 border-b border-white/10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-white/50 text-sm">Create a new product listing</p>
          </div>
          <Link
        ...
        >
          ...
          <div className="mb-6">
            ...
            <p className="text-white/40 text-xs mt-2">
              JPG, PNG or WebP. Max 5MB. If no image is uploaded, a placeholder
